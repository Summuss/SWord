...
@Database(entities = {BookNode.class, DeleteRecord.class, Word.class, WordBookNodeJoin.class, Meaning.class, Sentence.class, CurrentStudyWord.class}, version = 11, exportSchema = false)
